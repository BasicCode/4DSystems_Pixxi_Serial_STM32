...
class Pixxi_Serial_4DLib
{
	public:
		...
		int img_ClearAttributes(uint16_t  Handle, uint16_t  Index, uint16_t  Value);
		int img_Darken(uint16_t  Handle, uint16_t  Index);
		int img_Disable(uint16_t  Handle, uint16_t  Index);
		int img_Enable(uint16_t  Handle, uint16_t  Index);
		int img_GetWord(uint16_t  Handle, uint16_t  Index, uint16_t  Offset );
		int img_Lighten(uint16_t  Handle, uint16_t  Index);
		int img_SetAttributes(uint16_t  Handle, uint16_t  Index, uint16_t  Value);
		int img_SetPosition(uint16_t  Handle, uint16_t  Index, uint16_t  Xpos, uint16_t  Ypos);
		int img_SetWord(uint16_t  Handle, uint16_t  Index, uint16_t  Offset , uint16_t  Word);
		int img_Show(uint16_t  Handle, uint16_t  Index);
		int img_Touched(uint16_t  Handle, uint16_t  Index);
		...
		int media_WrSector(uint8_t *  SectorOut);
		int mem_Alloc(uint16_t size);
		int mem_Free(uint16_t  Handle);
		int mem_Heap();
		int pin_HI(uint16_t Pin);
		int peekM(uint16_t  Address);
		int pin_LO(uint16_t Pin);
		int pin_Read(uint16_t Pin);
		int pin_Set(uint16_t Mode, uint16_t Pin);
